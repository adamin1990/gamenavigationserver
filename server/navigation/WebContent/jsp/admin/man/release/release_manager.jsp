...
<body>
	<div class="main2">
		...
		<s:form action="findAllRelease" method="post" id="myframe" name="formName">
			<s:hidden name="page"/>
			<table>
				<tr>
				...
				<tr style="background-color: #4876FF">
					<td align="left" width="350px;" height="30px;">
					<input type="checkbox" name="alls" onClick="selectAll('formName','no')" title="全选/取消全选">发布人名称</td> 
				</tr>
		...
		<script type="text/javascript">
			...
			function removet(){ 
				...
				formName.action="deleteRelease.action"; 
				formName.submit();  
				} 
			function release(){
				window.location.href="<%=path%>/admin/addRelease.action";
				}
			function modify(){ 
				if(selectedId==null)
				{
				...
				window.location.href="<%=path%>/admin/findReleaseById.action?rid="+selectedId;
				}  
			/* 是否全选标记 */
